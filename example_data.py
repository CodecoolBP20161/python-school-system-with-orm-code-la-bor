...
interviews = [
                {'start_date': '2016-09-01 11:00:00', 'end_date': '2016-09-01 11:30:00', 'mentor': Mentor.get(Mentor.first_name == 'Mateusz', Mentor.last_name == 'Ostafil' ), 'school': School.get(School.name == 'CodecoolKrakow'), 'available': True},
                {'start_date': '2016-09-01 11:30:00', 'end_date': '2016-09-01 12:00:00', 'mentor': Mentor.get(Mentor.first_name == 'Attila', Mentor.last_name == 'Molnár', 'school': School.get(School.name == 'CodecoolMiskolc'), 'available': True},
